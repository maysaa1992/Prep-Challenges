...
function square(arr) {
    ...
    let result = [];
    arr.forEach(element => result.push(element*element));
    return result;
}
// -------------------------------------------------------------------------------------------------------
...
function fullName(arr) {
    ...
    for(let i=0;i<arr.length;i++){
        let result=arr[i].firstName +" "+ arr[i].lastName;
        newArr.push(result);  
    }
    return newArr;
}
...
function gradesAvg(arr) {
    ...
    let result=0
    for(let i=0;i<arr.length;i++){
    arr[i].gradsList.map(funAvg)

    }
  function funAvg(data){
    for (let j=0;j<data.length;j++){
     let sumOfArr=0
     sumOfArr +=data[j];
    }
    result=sumOfArr/data.length
    arr.avg=arr.push(result);
  }
 return arr
}
// -------------------------------------------------------------------------------------------------------
