...
const customerAndAge = (obj) => {
  ...
  const arrStringFormat =[];
for (const property in obj) {
  const stringFormat = `Customer Name :${property} , Age :${obj[property]}`;
arrStringFormat.push(stringFormat);
}
return arrStringFormat;
};
// -------------------------------------------------------------------------------------------------------
...
const getEntries = (obj) => {
  ...
  const arrStringFormat =[];
  for (const property in obj) {
    const stringFormat = `${property}: ${obj[property]}`;
  arrStringFormat.push(stringFormat);
  }
  return arrStringFormat;
};
